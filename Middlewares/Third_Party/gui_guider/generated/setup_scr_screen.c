...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_label_1, 24, 26);
    lv_obj_set_size(ui->screen_label_1, 269, 19);
    ...
    lv_label_set_text(ui->screen_btn_1_label, "LED_G OFF");
    lv_label_set_long_mode(ui->screen_btn_1_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->screen_btn_1_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->screen_btn_1, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->screen_btn_1_label, LV_PCT(100));
    lv_obj_set_pos(ui->screen_btn_1, 105, 107);
    lv_obj_set_size(ui->screen_btn_1, 100, 36);
    ...
    lv_label_set_text(ui->screen_btn_2_label, "LED_G ON");
    ...
    lv_obj_set_pos(ui->screen_btn_2, 105, 181);
    lv_obj_set_size(ui->screen_btn_2, 100, 39);
